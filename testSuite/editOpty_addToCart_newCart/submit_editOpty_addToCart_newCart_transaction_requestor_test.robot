...
Create Transaction Requestor Child New Cart Test
    ...
    ${SKU_NUMBER}        ${CATATANTRANSAKSI}          a.parentrequestor@grr.la      ${PASSWORD}       PARENTREQUESTOR     ${OPTYNAME}
    ${SKU_NUMBER}        ${CATATANTRANSAKSI}          a.requestor@grr.la            ${PASSWORD}       UB2 REQUESTOR       ${OPTYNAME}
