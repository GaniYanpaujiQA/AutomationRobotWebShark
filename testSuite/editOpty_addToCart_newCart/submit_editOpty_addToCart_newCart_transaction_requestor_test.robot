...
${OPTYNAME}           Opty Name
*** Test Cases ***
Create Transaction Requestor Child New Cart Test
    [Timeout]     5 minute
    [Template]    Create Transaction Requestor Child New Cart Get Opty
    ...
    ${SEARCHDATA}        ${CATATANTRANSAKSI}          a.parentrequestor@grr.la      ${PASSWORD}       PARENTREQUESTOR     ${OPTYNAME}
    ${SEARCHDATA}        ${CATATANTRANSAKSI}          a.requestor@grr.la            ${PASSWORD}       UB2 REQUESTOR       ${OPTYNAME}         
...
#     ${SELECTALL}
*** Keywords ***
Create Transaction Requestor Child New Cart Get Opty
